...
const EricRyanSwanson = () => (
  <div>
    <div className="card-inside">
      ...
      <div className="hvrbox2">
        <a
          href="https://github.com/JonathanHelvey/EricRyanSwanson"
          target="_blank"
      ...
      <div className="details">
        <h4 className="project-title2">Actors Portfolio Site</h4>
      </div>
    </div>
  </div>
);

export default EricRyanSwanson;
